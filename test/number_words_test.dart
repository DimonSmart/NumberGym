...
import 'package:hello_label/features/training/data/number_words.dart';
...
void main() {
  test('numberToEnglish handles edges', () {
    ...
    expect(() => numberToEnglish(101), throwsRangeError);
  });
  ...
  test('numberToSpanish handles edges', () {
    ...
    expect(() => numberToSpanish(101), throwsRangeError);
  });
}
