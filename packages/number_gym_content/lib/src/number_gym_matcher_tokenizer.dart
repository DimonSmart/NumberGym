...
class NumberGymMatcherTokenizer implements MatcherTokenizer {
  NumberGymMatcherTokenizer(this._pack)
...
const _operatorSymbols = <String, String>{
  '+': 'PLUS',
  '-': 'MINUS',
  '*': 'MULTIPLY',
  '/': 'DIVIDE',
